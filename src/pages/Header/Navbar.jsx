...
const Navbar = () => {
    ...
    return (
        <nav className="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#e7eff3] px-10 py-3">
            ...
            >
                <svg className="w-7 h-7 text-[#0d171b]" fill="none" stroke="currentColor" strokeWidth="2"
            ...
            {/* Mobile Menu */}
            {isOpen && (
                <div className="absolute top-16 left-0 w-full bg-white shadow-lg z-30 flex flex-col items-center py-4 gap-4 md:hidden">
                    <NavLink to="/" className="text-[#0d171b] text-base font-medium" onClick={() => setIsOpen(false)}>Home</NavLink>
                    <NavLink to="/mess" className="text-[#0d171b] text-base font-medium" onClick={() => setIsOpen(false)}>Mess</NavLink>
                    <NavLink to="/about" className="text-[#0d171b] text-base font-medium" onClick={() => setIsOpen(false)}>About</NavLink>
                    <NavLink to="/contact" className="text-[#0d171b] text-base font-medium" onClick={() => setIsOpen(false)}>Contact</NavLink>
                    <Button variant="nav">
